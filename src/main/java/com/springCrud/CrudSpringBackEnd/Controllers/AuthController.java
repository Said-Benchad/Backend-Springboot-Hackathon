...
import com.springCrud.CrudSpringBackEnd.Service.RecetteService;
...
public class AuthController implements WebMvcConfigurer {
    ...
    //insert
    @PostMapping("/ajouterRecette/{id}")
    public Recette AjouterRecette(@RequestBody Recette recette, @PathVariable long id){
        System.out.println(recette.getNom());
        return recetteService.ajouterRecette(recette,id);
    }



    @PostMapping("/deleteRecette/{id}")
    public void DeleteRecette(@PathVariable long id){
         recetteService.DeleteRecette(id);
    }
    @PostMapping("/updateRecette/{id}")
    public Recette UpdateRecette(@RequestBody Recette recette, @PathVariable long id){
        System.out.println(recette.getNom());
        return recetteService.Update(recette,id);
    }
